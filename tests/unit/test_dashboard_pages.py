...
class TestAuditTableRowBuilding:
    ...
    def test_rows_built_correctly(self, sample_logs):
        ...
        from dashboard.views.audit_log import ACTION_COLORS
...
class TestExportButtonLogic:
    ...
    def test_render_export_button_calls_download_button(self, sample_logs):
        with patch("dashboard.views.audit_log.st") as mock_st:
            from dashboard.views.audit_log import _render_export_button
...
class TestParseDate:
    def test_valid_iso_timestamp(self):
        from dashboard.views.audit_log import _parse_date
...
class TestTriggerFormLogic:
    def test_trigger_form_no_devices_shows_warning(self):
        ...
        with patch("dashboard.views.deployments.st") as mock_st:
            ...
            from dashboard.views.deployments import _render_trigger_form
    ...
    def test_trigger_form_success_shows_success_message(self, sample_devices):
        mock_client = MagicMock()
        mock_client.get_config_history.return_value = [{"id": "cfg-1"}]
        mock_client.trigger_deployment_detailed.return_value = {
            "success": True,
        ...
        with patch("dashboard.views.deployments.st") as mock_st:
            ...
            mock_st.number_input.return_value = 65001
            mock_st.radio.return_value = "atomic"
            mock_st.text_input.side_effect = ["0.0.0.0", "latest"]
            mock_st.columns.return_value = (MagicMock(), MagicMock())
        ...
        mock_client.trigger_deployment_detailed.assert_called_once()
...
class TestDeviceActionsLogic:
    def test_health_check_success_shows_success(self, sample_devices):
        ...
        with patch("dashboard.views.devices.st") as mock_st:
            ...
            from dashboard.views.devices import _render_device_actions
...
class TestRenderFunctionsTopLevel:
    def test_audit_render_empty_logs(self):
        ...
        with patch("dashboard.views.audit_log.st") as mock_st:
            ...
            from dashboard.views.audit_log import render
            render(mock_client)
    ...
    def test_devices_render_no_devices_shows_info(self):
        ...
        with patch("dashboard.views.devices.st") as mock_st:
            ...
            from dashboard.views.devices import render
            render(mock_client)
    ...
    def test_deployments_render_no_deployments_shows_info(self):
        ...
        with patch("dashboard.views.deployments.st") as mock_st:
            ...
            from dashboard.views.deployments import render
            render(mock_client)
