...
from api.models import Base  # noqa: F401 — registers all tables

# this is the Alembic Config object, which provides access to
# the values within the .ini file in use.
config = context.config

# Allow DATABASE_URL to be overridden via environment variable (used in Docker).
...
# The target_metadata for autogenerate support
...
def run_migrations_offline() -> None:
    ...
    an Engine is also acceptable here.  By skipping the Engine creation
